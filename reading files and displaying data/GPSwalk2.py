...
dpath = r'reading files and displaying data\data\lake_may_walk.csv'
mpath = r'reading files and displaying data\lakemap.png'
col_list = [3, 4]
df = pd.read_csv(dpath, header = 1, usecols=col_list)
...
class GPS(object):
    ...
    def create_image(self, color, width=2):
        ...
        data = pd.read_csv(self.dpath, header=1, usecols=col_list, names=['LATITUDE', 'LONGITUDE'], sep=',', error_bad_lines=False)
